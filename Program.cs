...
namespace RegentHealthBookingSystem
{
    class Program
    {
        ...
        //? Have chance to system to be avalible to call from the objet 
        static bool Login(BookingSystem system)
        { 
            // Reference for variables: https://www.w3schools.com/cs/cs_variables.php
            ...
            // Rf for if else https://www.w3schools.com/cs/cs_conditions.php
            // Conditional statement if  to validate credentials of the user using a if stamente 
            if (u == "Doctor1" && p == "Regent_2026")
            {
    ...
    ");
            ...
            Console.ResetColor();
            system.AddActivity("Someone tried to access");
        ...
        static void Main()
        {
            ...
            // rf for the while https://www.w3schools.com/cs/cs_while_loop.php
            while (!Login(system)) { }
            ...
            // Main application loop: stays active until the user selects 'Logout number 6 will close the menu'
            while (running)
            {
                ...
                switch (Console.ReadLine())
                {
                    ...
                    case "1":
                        ...
                        // for call  the methodn https://www.w3schools.com/cs/cs_methods.php
